...
subroutine initializePotvars()
    ...
    i = 0
    !Read_scale_factor
    open(unit =11,file ="PotFitParams2FE/scale_factor_avtz_ref.dat",status="old") 
    ...
    !****************************************************************************************************************************************#
    open(unit=101,file='PotFitParams2FE/fitted_param_quad_8_6_even_fortran.dat',status='old')
    ...
    open(unit=102,file='PotFitParams2FE/fitted_param_qubic_gt5_8_6_even_fortran.dat',status='old')
    ...
    open(unit=103,file='PotFitParams2FE/fitted_param_qubic_lt5_6_6_even_fortran.dat',status='old')
    ...
    open(unit=104,file='PotFitParams2FE/fitted_param_qubic_lt2_5_5_even_fortran.dat',status='old')
    ...
    open(unit=105,file='PotFitParams2FE/fitted_param_quartic_gt5_8_6_even_fortran.dat',status='old')
    ...
    open(unit=106,file='PotFitParams2FE/fitted_param_quartic_lt5_6_6_even_fortran.dat',status='old')
    ...
    open(unit=107,file='PotFitParams2FE/fitted_param_quartic_lt2_5_5_even_fortran.dat',status='old')
    ...
    open(unit=108,file='PotFitParams2FE/fitted_param_quartic_ltpt1_even_fortran.dat',status='old')
    ...
    open(unit=201,file='PotFitParams2FE/fitted_param_quad_8_6_odd_fortran.dat',status='old')
    ...
    open(unit=202,file='PotFitParams2FE/fitted_param_qubic_gt5_8_6_odd_fortran.dat',status='old')
    ...
    open(unit=203,file='PotFitParams2FE/fitted_param_qubic_lt5_6_6_odd_fortran.dat',status='old')
    ...
    open(unit=204,file='PotFitParams2FE/fitted_param_qubic_lt2_5_5_odd_fortran.dat',status='old')
    ...
    open(unit=205,file='PotFitParams2FE/fitted_param_quartic_gt5_8_6_odd_fortran.dat',status='old')
    ...
    open(unit=206,file='PotFitParams2FE/fitted_param_quartic_lt5_6_6_odd_fortran.dat',status='old')
    ...
    open(unit=207,file='PotFitParams2FE/fitted_param_quartic_lt2_5_5_odd_fortran.dat',status='old')
    ...
    open(unit=208,file='PotFitParams2FE/fitted_param_quartic_ltpt1_odd_fortran.dat',status='old')
    ...
    open(unit=109,file='PotFitParams2FE/fitted_param_qo_3_3_even_fortran.dat',status='old')
    ...
    open(unit=110,file='PotFitParams2FE/fitted_param_qo_3_3_ang_even_fortran.dat',status='old')
    ...
    open(unit=209,file='PotFitParams2FE/fitted_param_qo_3_3_odd_fortran.dat',status='old')
    ...
    call Read_Vt_coeff("PotFitParams2FE/pot_par_8_6.dat",fn_order_pot,Vt_coeff )
    !Vt_coeff = In Hartee
    !Symmetrized internal coordinate fit
    open(unit=302,file='PotFitParams2FE/eq_par_8_6_even_fortran.dat',status='old')
    ...
    open(unit=303,file='PotFitParams2FE/eq_par_8_6_odd_fortran.dat',status='old')
    ...
    call Read_atom_ind("PotFitParams2FE/atom_ind.dat",Natoms,atom_ind)
    n_fix_tors = 2 
